...
public class UrlAddress {
    ...
    //请帖模板图片
    public static final String MUBAN_IMAGE_ADDRESS = HOST_ADDRESS + "images/invateImages/invateMuBan/";

    //用户请帖图片
    public static final String INVITE_IMAGE_ADDRESS = HOST_ADDRESS + "images/invateImages/";
}