...
public class SocialFannaojiDetailActivity extends AppCompatActivity {
    PostBean mPostBean;
    //定义视图
    View mFannaojiDetailView;
    //定义适配器
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPostBean= (PostBean) intent.getSerializableExtra("postfannaoji");
        tv_headviewTitle.setText(mPostBean.getPostTitle());
        mPostDetailAdapter=new PostDetailAdapter(SocialFannaojiDetailActivity.this,mPostBean,imagesUrlList,replyList);
        fannaojiListView.setAdapter(mPostDetailAdapter);

        //获取帖子内容
        String result = PrefUtils.getString(SocialFannaojiDetailActivity.this, "fannaoji_ninepic_detail", null);
        if (result != null) {
            parseData(result);
        }
        getPostImagesDatas();
        ...
        //获取回复贴的内容
        String results=PrefUtils.getString(SocialFannaojiDetailActivity.this,"fananoji_replypost",null);
        if (results!=null){
            parseDatas(results);
        }
        getReplyPostDatas();
    ...
    private void getReplyPostDatas() {
        ...
        x.http().get(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String results) {
                PrefUtils.setString(SocialFannaojiDetailActivity.this,"fananoji_replypost",null);
                parseDatas(results);
            }
    ...
    private void getPostImagesDatas() {
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                PrefUtils.setString(SocialFannaojiDetailActivity.this, "fannaoji_ninepic_detail", result);
                parseData(result);
            }
    ...
    private void initListeners() {
        ...
        ib_addmenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mMenuPopupWindow=new AddMenuPopupWindow(SocialFannaojiDetailActivity.this,itemsOnClick);
                //显示窗口
                //设置layout在PopupWindow中显示的位置
                mMenuPopupWindow.showAtLocation(SocialFannaojiDetailActivity.this.findViewById(R.id.ll_addmenu), Gravity.BOTTOM| Gravity.CENTER_HORIZONTAL, 0, 0);
            }
        });
    ...
    private View.OnClickListener itemsOnClick =new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                case R.id.wxShare:
                    Toast.makeText(SocialFannaojiDetailActivity.this, "你点击了微信分享", Toast.LENGTH_SHORT).show();
                    break;
                case R.id.qqShare:
                    Toast.makeText(SocialFannaojiDetailActivity.this, "你点击了QQ分享", Toast.LENGTH_SHORT).show();
                    break;
                case R.id.weiboShare:
                    Toast.makeText(SocialFannaojiDetailActivity.this, "你点击了微博分享", Toast.LENGTH_SHORT).show();
                    break;
                case R.id.item_addmenupopupwindow_Collection:
                    uploadCollectPost();
                    Toast.makeText(SocialFannaojiDetailActivity.this, "你点击了收藏", Toast.LENGTH_SHORT).show();
                    break;
                case R.id.item_addmenupopupwindow_Cancel:
                    Toast.makeText(SocialFannaojiDetailActivity.this, "你点击了退出", Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;
            }
    ...
    private void uploadCollectPost() {
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            @Override
            public void onSuccess(String result) {
                new SweetAlertDialog(SocialFannaojiDetailActivity.this,SweetAlertDialog.SUCCESS_TYPE)
                        .setTitleText("收藏帖子成功!")
                        .show();
            }
    ...
    private void uploadreplyData() {
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                Log.e("数据","回复成功");
                replyDialog=null;
                replyDialog=new SweetAlertDialog(SocialFannaojiDetailActivity.this,SweetAlertDialog.PROGRESS_TYPE);
    ...
    private void initView() {
        ...
        //初始化所有控件
        fannaojiListView= (ListView) this.findViewById(R.id.listview_detailview);
        ...
        //添加headview到详情界面中
        fannaojiListView.addHeaderView(ll_headview);
        //帖子详情的headview的id
