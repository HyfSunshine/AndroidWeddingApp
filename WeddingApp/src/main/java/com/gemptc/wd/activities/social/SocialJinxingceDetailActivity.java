...
public class SocialJinxingceDetailActivity extends AppCompatActivity {
    PostBean mPostBean;
    //定义视图
    View mJinxingceDetailView;
    //定义适配器
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPostBean= (PostBean) intent.getSerializableExtra("postjinxingce");
        tv_headviewTitle.setText(mPostBean.getPostTitle());
        mPostDetailAdapter=new PostDetailAdapter(SocialJinxingceDetailActivity.this,mPostBean,imagesUrlList,replyList);
        jinxingceListView.setAdapter(mPostDetailAdapter);

        //获取帖子内容
        String result = PrefUtils.getString(SocialJinxingceDetailActivity.this, "jinxingce_ninepic_detail", null);
        if (result != null) {
            parseData(result);
        }
        getPostImagesDatas();
        ...
        //获取回复贴的内容
        String results=PrefUtils.getString(SocialJinxingceDetailActivity.this,"jinxingce_replypost",null);
        if (results!=null){
            parseDatas(results);
        }
        getReplyPostDatas();
    ...
    private void getReplyPostDatas() {
        ...
        x.http().get(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String results) {
                PrefUtils.setString(SocialJinxingceDetailActivity.this,"jinxingce_replypost",null);
                parseDatas(results);
            }
    ...
    private void getPostImagesDatas() {
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                PrefUtils.setString(SocialJinxingceDetailActivity.this, "jinxingce_ninepic_detail", result);
                parseData(result);
            }
    ...
    private void initListeners() {
        ...
        ib_addmenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mMenuPopupWindow=new AddMenuPopupWindow(SocialJinxingceDetailActivity.this,itemsOnClick);
                //显示窗口
                //设置layout在PopupWindow中显示的位置
                mMenuPopupWindow.showAtLocation(SocialJinxingceDetailActivity.this.findViewById(R.id.ll_addmenu), Gravity.BOTTOM| Gravity.CENTER_HORIZONTAL, 0, 0);
            }
        });
    ...
    private View.OnClickListener itemsOnClick=new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                case R.id.wxShare:
                    Toast.makeText(SocialJinxingceDetailActivity.this, "你点击了微信分享", Toast.LENGTH_SHORT).show();
                    break;
                case R.id.qqShare:
                    Toast.makeText(SocialJinxingceDetailActivity.this, "你点击了QQ分享", Toast.LENGTH_SHORT).show();
                    break;
                case R.id.weiboShare:
                    Toast.makeText(SocialJinxingceDetailActivity.this, "你点击了微博分享", Toast.LENGTH_SHORT).show();
                    break;
                case R.id.item_addmenupopupwindow_Collection:
                    uploadCollectPost();
                    Toast.makeText(SocialJinxingceDetailActivity.this, "你点击了收藏", Toast.LENGTH_SHORT).show();
                    break;
                case R.id.item_addmenupopupwindow_Cancel:
                    Toast.makeText(SocialJinxingceDetailActivity.this, "你点击了退出", Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;
            }
    ...
    private void uploadCollectPost() {
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            @Override
            public void onSuccess(String result) {
                new SweetAlertDialog(SocialJinxingceDetailActivity.this,SweetAlertDialog.SUCCESS_TYPE)
                        .setTitleText("收藏帖子成功!")
                        .show();
            }
    ...
    private void uploadreplyData() {
        ...
        x.http().post(params, new Callback.CommonCallback<String>() {
            ...
            public void onSuccess(String result) {
                Log.e("数据","回复成功");
                replyDialog=null;
                replyDialog=new SweetAlertDialog(SocialJinxingceDetailActivity.this,SweetAlertDialog.PROGRESS_TYPE);
    ...
    private void initView() {
        //初始化所有控件
        jinxingceListView= (ListView) this.findViewById(R.id.listview_detailview);
        ...
        //添加headview到详情界面中
        jinxingceListView.addHeaderView(ll_headview);
        //帖子详情的headview的id
